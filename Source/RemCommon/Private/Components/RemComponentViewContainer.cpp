...
void FRemComponentViewContainerInstance::SetComponentsView(
    const TConstArrayView<TConstStructView<FRemComponentViewBase>> InComponentsView)
{
    TryUninitialize();
...
void FRemComponentViewContainerInstance::SetComponentsView(
    const TConstArrayView<TInstancedStruct<FRemComponentViewBase>> InComponentsView)
{
    TryUninitialize();
