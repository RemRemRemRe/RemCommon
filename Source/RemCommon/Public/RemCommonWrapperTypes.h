...
struct REMCOMMON_API FRemDataAssetWrapper
{
    ...
    REM_DEFINE_TEMPLATE_GETTER_RETURN_VALUE(std::derived_from<UDataAsset>, DataAsset, /*no suffix*/,
        Cast<T>(DataAsset.Get()))

    using IsObjectWrapper = std::true_type;
    REM_DEFINE_GETTERS_RETURN_VALUE(Object, /*no suffix*/, DataAsset.Get())
    REM_DEFINE_TEMPLATE_GETTER_RETURN_VALUE(std::derived_from<UDataAsset>, Object, /*no suffix*/,
        Cast<T>(DataAsset.Get()))
...
struct REMCOMMON_API FRemMaterialWrapper
{
    ...
    REM_DEFINE_TEMPLATE_GETTER_RETURN_VALUE(std::derived_from<UMaterialInterface>, Material, /*no suffix*/,
        Cast<T>(Material.Get()))

    using IsObjectWrapper = std::true_type;
    REM_DEFINE_GETTERS_RETURN_VALUE(Object, /*no suffix*/, Material.Get())
    REM_DEFINE_TEMPLATE_GETTER_RETURN_VALUE(std::derived_from<UMaterialInterface>, Object, /*no suffix*/,
        Cast<T>(Material.Get()))
...
struct REMCOMMON_API FRemStreamableRenderAssetWrapper
{
    ...
    REM_DEFINE_TEMPLATE_GETTER_RETURN_VALUE(std::derived_from<UStreamableRenderAsset>, StreamableRenderAsset,
        /*no suffix*/, Cast<T>(StreamableRenderAsset))

    using IsObjectWrapper = std::true_type;
    REM_DEFINE_GETTERS_RETURN_VALUE(Object, /*no suffix*/, StreamableRenderAsset)
    REM_DEFINE_TEMPLATE_GETTER_RETURN_VALUE(std::derived_from<UStreamableRenderAsset>, Object, /*no suffix*/,
        Cast<T>(StreamableRenderAsset))
...
struct REMCOMMON_API FRemWeakStreamableRenderAssetWrapper
{
    ...
    REM_DEFINE_TEMPLATE_GETTER_RETURN_VALUE(std::derived_from<UStreamableRenderAsset>, StreamableRenderAsset, ,
        Cast<T>(StreamableRenderAsset.Get()))
