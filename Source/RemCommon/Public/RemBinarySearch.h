...
template <typename RangeValueType, typename SizeType, typename PredicateValueType, typename ProjectionType, typename
          SortPredicateType>
SizeType LowerBound(RangeValueType& Range, const SizeType Num, const PredicateValueType& Value,
...
template <typename RangeValueType, typename SizeType, typename PredicateValueType, typename ProjectionType, typename
          SortPredicateType>
SizeType UpperBound(RangeValueType& Range, const SizeType Num, const PredicateValueType& Value,
    ProjectionType Projection, SortPredicateType SortPredicate)
{
    // Current start of sequence to check
    SizeType Start = 0;
...
[[nodiscard]] auto BinarySearch(const RangeType& Range, const ValueType& Value, ProjectionType Projection,
