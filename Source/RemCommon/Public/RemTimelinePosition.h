...
inline bool FRemTimelinePositionBase::IsWithinInclusive(
    const FRemTimelinePosition_TimeAndFrame& TimeAndFrame) const
{
    return false;
}

inline bool FRemTimelinePosition_Time::IsWithinInclusive(
    const FRemTimelinePosition_TimeAndFrame& TimeAndFrame) const
{
    return TimeAndFrame.Time > Time;
}

inline bool FRemTimelinePosition_Frame::IsWithinInclusive(
    const FRemTimelinePosition_TimeAndFrame& TimeAndFrame) const
{
