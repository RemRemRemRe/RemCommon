...
bool FRemTimelinePosition_TimeAndFrame::IsWithinInclusive(
...
bool FRemTimelinePositionRange_Time::IsWithinInclusive(
    const FRemTimelinePosition_TimeAndFrame& TimeAndFrame) const
{
    switch (RangeFormat)
    {
...
bool FRemTimelinePositionRange_Frame::IsWithinInclusive(
    const FRemTimelinePosition_TimeAndFrame& TimeAndFrame) const
{
    switch (RangeFormat)
    {
