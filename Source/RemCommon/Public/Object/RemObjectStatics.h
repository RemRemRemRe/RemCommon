...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Rem|Actor",
...
REM_API void ForeachObjectInArray(TNotNull<const FArrayProperty*> ArrayProperty,
    TNotNull<const UObject*> InContainer,
...
REM_API bool CheckPropertyChainByNames(const FEditPropertyChain& PropertyChain,
    const TArray<FName>& PropertyNamePath, bool bShouldHaveNextNode = false);
...
REM_API FTimerHandle SetTimerForThisTick(TNotNull<const UObject*> WorldContextObject,
...
REM_API FTimerHandle SetTimerForNextTick(TNotNull<const UObject*> WorldContextObject,
    const FTimerDelegate& Delegate);
