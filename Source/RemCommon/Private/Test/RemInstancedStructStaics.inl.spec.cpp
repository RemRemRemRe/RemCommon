...
void FRemInstancedStructStaicsInlineTest::Define()
{
    Describe(TEXT("Test API FindStructView"), [this]
    {
        It(TEXT("should pass for empty array of struct utils type"), [this]
        {
            ...
            TestEqual(TEXT("EmptyView"), Rem::Struct::FindStructView<FRemEmptyStruct>(MakeArrayView(A)).Get<0>(),
                EmptyView);
            TestEqual(TEXT("EmptyView"), Rem::Struct::FindStructView<FRemEmptyStruct>(MakeArrayView(B)).Get<0>(),
                EmptyView);
            TestEqual(TEXT("EmptyView"), Rem::Struct::FindStructView<FRemEmptyStruct>(MakeArrayView(C)).Get<0>(),
                EmptyView);
            TestEqual(TEXT("EmptyView"), Rem::Struct::FindStructView<FRemEmptyStruct>(MakeArrayView(D)).Get<0>(),
                EmptyView);
            TestEqual(TEXT("EmptyView"), Rem::Struct::FindStructView<FRemEmptyStruct>(MakeArrayView(E)).Get<0>(),
                EmptyView);
            TestEqual(TEXT("EmptyView"), Rem::Struct::FindStructView<FRemEmptyStruct>(MakeArrayView(F)).Get<0>(),
                EmptyView);
            TestEqual(TEXT("EmptyView"), Rem::Struct::FindStructView<FRemEmptyStruct>(MakeArrayView(G)).Get<0>(),
                EmptyView);
            TestEqual(TEXT("EmptyView"), Rem::Struct::FindStructView<FRemEmptyStruct>(MakeArrayView(H)).Get<0>(),
                EmptyView);

            constexpr TConstStructView<FRemEmptyStruct> ConstEmptyView{};
            TestEqual(TEXT("ConstEmptyView"),
            ...
            TestEqual(TEXT("ConstEmptyView"),
                Rem::Struct::FindConstStructView<FRemEmptyStruct>(MakeConstArrayView(C)).Get<0>(), ConstEmptyView);
            TestEqual(TEXT("ConstEmptyView"),
                Rem::Struct::FindConstStructView<FRemEmptyStruct>(MakeConstArrayView(D)).Get<0>(), ConstEmptyView);
            TestEqual(TEXT("ConstEmptyView"),
                Rem::Struct::FindConstStructView<FRemEmptyStruct>(MakeConstArrayView(E)).Get<0>(), ConstEmptyView);
            TestEqual(TEXT("ConstEmptyView"),
                Rem::Struct::FindConstStructView<FRemEmptyStruct>(MakeConstArrayView(F)).Get<0>(), ConstEmptyView);
            TestEqual(TEXT("ConstEmptyView"),
                Rem::Struct::FindConstStructView<FRemEmptyStruct>(MakeConstArrayView(G)).Get<0>(), ConstEmptyView);
            TestEqual(TEXT("ConstEmptyView"),
                Rem::Struct::FindConstStructView<FRemEmptyStruct>(MakeConstArrayView(H)).Get<0>(), ConstEmptyView);
        });
        ...
        It(TEXT("should pass for non empty array of struct utils type"), [this]
        {
            ...
            TestNotEqual(TEXT("EmptyView"), Rem::Struct::FindStructView<FRemEmptyStruct>(MakeArrayView(C)).Get<0>(),
                EmptyView);
            TestNotEqual(TEXT("EmptyView"), Rem::Struct::FindStructView<FRemEmptyStruct>(MakeArrayView(D)).Get<0>(),
                EmptyView);
            TestNotEqual(TEXT("EmptyView"), Rem::Struct::FindStructView<FRemEmptyStruct>(MakeArrayView(E)).Get<0>(),
                EmptyView);
            TestNotEqual(TEXT("EmptyView"), Rem::Struct::FindStructView<FRemEmptyStruct>(MakeArrayView(F)).Get<0>(),
                EmptyView);
            TestNotEqual(TEXT("EmptyView"), Rem::Struct::FindStructView<FRemEmptyStruct>(MakeArrayView(G)).Get<0>(),
                EmptyView);
            TestNotEqual(TEXT("EmptyView"), Rem::Struct::FindStructView<FRemEmptyStruct>(MakeArrayView(H)).Get<0>(),
                EmptyView);
